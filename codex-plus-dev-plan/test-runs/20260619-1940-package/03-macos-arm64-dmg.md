...
- No macOS arm64 test machine or runner was available in this pass.
- No macOS arm64 DMG file or hash was produced.
...
- Missing-Codex first-run assistant behavior was not verified on macOS arm64.
- Overwrite, remove or uninstall, and reinstall behavior was not verified.
- Gatekeeper or quarantine behavior was not verified.

## Release Boundary

macOS arm64 package evidence remains a full cross-platform release blocker, but it is deferred post-MVP by the 2026-06-19 owner decision that MVP package scope is Windows x64 only.
