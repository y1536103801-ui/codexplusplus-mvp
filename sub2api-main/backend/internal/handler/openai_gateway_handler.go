...
func (h *OpenAIGatewayHandler) SetCodexPlusGatewayPolicyService(policyService *service.CodexPlusGatewayPolicyService) {
	if h != nil {
...
func (h *OpenAIGatewayHandler) Responses(c *gin.Context) {
	...
	if !h.enforceCodexPlusGatewayPolicy(c, apiKey, subscription, reqModel, "/v1/responses", func(status int, code, message string) {
