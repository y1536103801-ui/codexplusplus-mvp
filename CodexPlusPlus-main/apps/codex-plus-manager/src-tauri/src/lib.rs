...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cloud_commands::codexplus_cloud_load_state,
            cloud_commands::codexplus_cloud_configure_endpoint,
            cloud_commands::codexplus_cloud_login,
            cloud_commands::codexplus_cloud_login_2fa,
            cloud_commands::codexplus_cloud_start_browser_handoff,
            cloud_commands::codexplus_cloud_poll_browser_handoff,
            cloud_commands::codexplus_cloud_cancel_browser_handoff,
            cloud_commands::codexplus_cloud_logout,
            cloud_commands::codexplus_cloud_refresh_bootstrap,
            cloud_commands::codexplus_cloud_register_device,
            cloud_commands::codexplus_cloud_apply_managed_provider,
            cloud_commands::codexplus_cloud_repair_managed_provider,
            cloud_commands::codexplus_cloud_redeem,
            cloud_commands::codexplus_cloud_load_usage,
            cloud_commands::codexplus_cloud_read_redacted_diagnostics
        ])
