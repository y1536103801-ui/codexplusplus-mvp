...
use codex_plus_core::codexplus_cloud::MANAGED_PROVIDER_ID;
...
#[test]
fn codexplus_cloud_profile_keeps_gateway_base_url_separate_from_codex_proxy() {
    let mut profile = RelayProfile {
        id: MANAGED_PROVIDER_ID.to_string(),
        model: "gpt-5-codex".to_string(),
        base_url: "https://gateway.example/v1".to_string(),
        upstream_base_url: "https://gateway.example/v1".to_string(),
        api_key: "sk-test-redacted".to_string(),
        protocol: RelayProtocol::Responses,
        relay_mode: RelayMode::PureApi,
        config_contents: r#"model = "gpt-5-codex"
model_provider = "custom"
...
"#
    ...
    assert_eq!(profile.upstream_base_url, "https://gateway.example/v1");
    ...
    assert!(
        !profile
            .config_contents
            .contains(r#"base_url = "https://gateway.example/v1""#)
    );
}
